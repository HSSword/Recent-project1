                                                    ...
                                                    <div class="card-body card-body_kal">
                                                        ...
                                                        <div class="col-md-12 ">
                                                            <div class="col-md-3 card-child daily_food">
                                                                Kcal<span class="icon-child pull-right"><i class="fa fa-arrow-up" aria-hidden="true"></i>{{isset($userfood)?$userfood->kcal:'0'}}kcal</span>
                                                            </div>
                                                            <div class="col-md-2 card-child daily_food">
                                                                <span class="icon-child"><i class="fa fa-arrow-up" aria-hidden="true"></i>{{isset($userfoodused)?$userfoodused->kcal:'0'}}kcal</span>
                                                            </div>
                                                            <div class="col-md-7 card-child">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="col-md-3 card-child daily_food">
                                                                Eiwit<span class="icon-child pull-right"><i class="fa fa-arrow-up" aria-hidden="true"></i>{{isset($userfood)?$userfood->eiwit:'0'}}g</span>
                                                            </div>
                                                            <div class="col-md-2 card-child daily_food">
                                                                <span class="icon-child"><i class="fa fa-arrow-up" aria-hidden="true"></i>{{isset($userfoodused)?$userfoodused->eiwit:'0'}}g</span>
                                                            </div>
                                                            <div class="col-md-7 card-child">
                                                                <div class="progress progress-xl progress-half-rounded light  daily_food" 
                                                                >
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="col-md-3 card-child daily_food">
                                                                Koolhydraten<span class="icon-child pull-right"><i class="fa fa-arrow-up" aria-hidden="true"></i>{{isset($userfood)?$userfood->koolhydraat:'0'}}g</span>
                                                            </div>
                                                            <div class="col-md-2 card-child daily_food">
                                                                <span class="icon-child"><i class="fa fa-arrow-up" aria-hidden="true"></i>{{isset($userfoodused)?$userfoodused->koolhydraat:'0'}}g</span>
                                                            </div>
                                                            <div class="col-md-7 card-child">
                                                                <div class="progress progress-xl progress-half-rounded light  daily_food" 
                                                                >
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="col-md-3 card-child daily_food">
                                                                Vezel<span class="icon-child pull-right"><i class="fa fa-arrow-up" aria-hidden="true"></i>{{isset($userfood)?$userfood->vezel:'0'}}g</span>
                                                            </div>
                                                            <div class="col-md-2 card-child daily_food">
                                                                <span class="icon-child"><i class="fa fa-arrow-up" aria-hidden="true"></i>{{isset($userfoodused)?$userfoodused->vezel:'0'}}g</span>
                                                            </div>
                                                            <div class="col-md-7 card-child">
                                                                <div class="progress progress-xl progress-half-rounded light  daily_food" 
                                                                >
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="col-md-3 card-child daily_food">
                                                                Vet<span class="icon-child pull-right"><i class="fa fa-arrow-up" aria-hidden="true"></i>{{isset($userfood)?$userfood->vet:'0'}}g</span>
                                                            </div>
                                                            <div class="col-md-2 card-child daily_food">
                                                                <span class="icon-child"><i class="fa fa-arrow-up" aria-hidden="true"></i>{{isset($userfoodused)?$userfoodused->vet:'0'}}g</span>
                                                            </div>
                                                            <div class="col-md-7 card-child">
                                                                <div class="progress progress-xl progress-half-rounded light  daily_food" 
                                                                >
                                            ...
                                            <div id="Kcal2" class="tab-pane">
                                                <section class="card">
                                                    <div class="card-body card-body_kal">
                                                        ...
                                                        <div class="col-md-12 ">
                                                            <div class="col-md-3 card-child daily_food">
                                                                Kcal<span class="icon-child pull-right"><i class="fa fa-arrow-up" aria-hidden="true"></i>{{isset($userfood)?$userfood->kcal_baw:'0'}}kcal</span>
                                                            </div>
                                                            <div class="col-md-2 card-child daily_food">
                                                                <span class="icon-child"><i class="fa fa-arrow-up" aria-hidden="true"></i>{{isset($userfoodused)?$userfoodused->kcal_baw:'0'}}kcal</span>
                                                            </div>
                                                            <div class="col-md-7 card-child">
                                                                <div class="progress progress-xl progress-half-rounded light daily_food" 
                                                                >
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="col-md-3 card-child daily_food">
                                                                Eiwit<span class="icon-child pull-right"><i class="fa fa-arrow-up" aria-hidden="true"></i>{{isset($userfood)?$userfood->eiwit_baw:'0'}}g</span>
                                                            </div>
                                                            <div class="col-md-2 card-child daily_food">
                                                                <span class="icon-child"><i class="fa fa-arrow-up" aria-hidden="true"></i>{{isset($userfoodused)?$userfoodused->eiwit_baw:'0'}}g</span>
                                                            </div>
                                                            <div class="col-md-7 card-child">
                                                                <div class="progress progress-xl progress-half-rounded light  daily_food" 
                                                                >
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="col-md-3 card-child daily_food">
                                                                Koolhydraten<span class="icon-child pull-right"><i class="fa fa-arrow-up" aria-hidden="true"></i>{{isset($userfood)?$userfood->koolhydraat_baw:'0'}}g</span>
                                                            </div>
                                                            <div class="col-md-2 card-child daily_food">
                                                                <span class="icon-child"><i class="fa fa-arrow-up" aria-hidden="true"></i>{{isset($userfoodused)?$userfoodused->koolhydraat_baw:'0'}}g</span>
                                                            </div>
                                                            <div class="col-md-7 card-child">
                                                                <div class="progress progress-xl progress-half-rounded light  daily_food" 
                                                                >
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="col-md-3 card-child daily_food">
                                                                Vezel<span class="icon-child pull-right"><i class="fa fa-arrow-up" aria-hidden="true"></i>{{isset($userfood)?$userfood->vezel_baw:'0'}}g</span>
                                                            </div>
                                                            <div class="col-md-2 card-child daily_food">
                                                                <span class="icon-child"><i class="fa fa-arrow-up" aria-hidden="true"></i>{{isset($userfoodused)?$userfoodused->vezel_baw:'0'}}g</span>
                                                            </div>
                                                            <div class="col-md-7 card-child">
                                                                <div class="progress progress-xl progress-half-rounded light  daily_food" 
                                                                >
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="col-md-3 card-child daily_food">
                                                                Vet<span class="icon-child pull-right"><i class="fa fa-arrow-up" aria-hidden="true"></i>{{isset($userfood)?$userfood->vet_baw:'0'}}g</span>
                                                            </div>
                                                            <div class="col-md-2 card-child daily_food">
                                                                <span class="icon-child"><i class="fa fa-arrow-up" aria-hidden="true"></i>{{isset($userfoodused)?$userfoodused->vet_baw:'0'}}g</span>
                                                            </div>
                                                            <div class="col-md-7 card-child">
                                                                <div class="progress progress-xl progress-half-rounded light  daily_food" 
                                                                >
                                ...
                                <div class="col-md-3 block-row">
                                        ...
                                        <div class="card-body">
                                            <div class="content daily_food">
                                             @php $msg=''; @endphp
                                             @if(isset($userfoodused))
                                                @if(isset($userfoodused->daily_note))
                                                    @php $msg=$userfoodused->daily_note; @endphp
                                                @endif
                                             @endif
                                             @if(isset($userfood) && $msg=='')
                                                @if(isset($userfood->daily_note))
                                                    @php $msg=$userfood->daily_note; @endphp
                                                @endif
                                             @endif
                                             @if($msg=='')
                                                @php $msg='Helaas, geen bericht'; @endphp
                                             @endif
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="card-body_columns">
                                                    ...
                                                    <div class="small-chart-wrapper">
                                                        ...
                                                        <div class="small-chart" id="sparklineBar{{$i}}"></div>

                                                        <div class="small-chart-info">

                                                            <strong class="daily_food">{{dutch_day($sectionData['kcaldays'][$i])}}</strong>
            ...
            <div class="col-lg-12">
                <div class="tabs tabs-dark bottom-tabs">
                    ...
                    <ul class="nav nav-tabs">
                        ...
                        @if(\App\TestQuestion::where('tests_id',$test->id)->where('show_graph','1')->count()>0)
                        <li class="nav-item">
                            <a class="nav-link" href="#{{$test->id}}" data-toggle="tab">{{$test->test_name}}</a>
                        </li>
                        @endif
                        @php $i=1; @endphp
                        @endforeach
               ...
               <div class="tab-content">
                    ...
                    @foreach($tests as $test)
                    @if(\App\TestQuestion::where('tests_id',$test->id)->where('show_graph','1')->count()>0)
                    <div id="{{$test->id}}" class="tab-pane">
                        <section class="card">
                            <div class="card-body">
                                  @foreach(\App\TestQuestion::where('tests_id',$test->id)->where('show_graph','1')->get() as $ques)
                                    @if($ques->status)
                                     <button type="button" class="mb-1 mt-1 mr-1 btn btn-primary">{{$ques->question}}</button>
                                    @endif
                                   @endforeach
                                  <div id="test-{{$test->id}}" class="tests-graph ct-chart ct-perfect-fourth ct-golden-section"></div>
                                 </div>
                            </section>
                        </div>
                    @endif
          ...
          <div class="row">
            <div class="col-lg-12">
               ...
               <div class="tab-content">
                    @php $i=0; @endphp
                    @foreach($tests as $test)
                    <div id="{{$test->id}}" class="tab-pane {{$i==0?'active':''}}">
                        <section class="card">
                            <div class="card-body">
                                <form action="{{route('admin.tests.answer',$test->id)}}" method="post"> 
                                {{csrf_field()}}
                                ...
                                <table class="test-table table table-responsive-lg table-bordered table-striped table-sm mb-0">
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <input type="{{$ques->type}}" class="form-control" name="answer[{{$ques->id}}]" data-url="{{route('admin.tests.answer',$test->id)}}"></td>
                                            @endif
                                           @endforeach
                                        ...
                                        <tr>
                                            ...
                                            <td style="padding: 5px">
                                                ...
                                                @endphp
                                                @if($ques->type=='date')
                                                    {{date('d-m-Y',strtotime($ans))}}
                                                @elseif($ques->type=='file')
                                                <a href="{{assets('/storage/uploads/'.$user->id.'/'.$test->id).'/'.$ans}}">{{$ans}}</a>
                                                @else
                                                {{$ans}}
                                                @endif  
                                            </td>
                    ...
                    <div class="tabs tabs-dark">
                        ...
                        <!-- tab form add-->
                            <div id="daily_food_add" class="tab-pane active">
                                <form service="form" action="{{route('admin.user.daily_food')}}" id="user_daily_food_add" method="post" enctype="multipart/form-data" onsubmit="submitForm('user_daily_food_add');" >
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-2">
                                            <label>Kcal</label>
                                            <input type="number" name="kcal" class="form-control" id="kcal" value="{{ old('kcal') }}" placeholder="ex: kcal">
                                            <span class="text-danger" id="kcal-error"></span>
                                        </div>
                                        <div class="form-group col-md-2">
                                            <label for="eiwit">Eiwit</label>
                                            <input type="number" min="0" name="eiwit" class="form-control" id="eiwit" placeholder="ex: eiwit" value="{{ old('eiwit') }}">
                                            <span class="text-danger" id="eiwit-error"></span>
                                        </div>
                                        <div class="form-group col-md-2">
                                            <label>Koolhydraten</label>
                                            <input type="number" min="0" name="koolhydraat" class="form-control" id="koolhydraat" value="{{ old('koolhydraat') }}" placeholder="ex: Koolhydraten">
                                            <span class="text-danger" id="koolhydraat-error"></span>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label for="vezel">Vezel</label>
                                            <input type="number" min="0" name="vezel" class="form-control" id="vezel" placeholder="ex: vezel" value="{{ old('vezel') }}">
                                            <span class="text-danger" id="vezel-error"></span>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label for="vet">vet</label>
                                            <input type="number" min="0" name="vet" class="form-control" id="vet" placeholder="ex: vet" value="{{ old('vet') }}">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-2">
                                            <label>Kcal</label>
                                            <input type="number" name="kcal_baw" class="form-control" id="kcal_baw" min="0" value="{{ old('kcal_baw') }}" placeholder="ex: kcal">
                                            <span class="text-danger" id="kcal_baw-error"></span>
                                        </div>
                                        <div class="form-group col-md-2">
                                            <label for="eiwit_baw">Eiwit</label>
                                            <input type="number" name="eiwit_baw" min="0" class="form-control" id="eiwit_baw" placeholder="ex: Eiwit" value="{{ old('eiwit_baw') }}">
                                            <span class="text-danger" id="eiwit_baw-error"></span>
                                        </div>
                                        <div class="form-group col-md-2">
                                            <label>Koolhydraten</label>
                                            <input type="number" name="koolhydraat_baw" min="0" class="form-control" id="koolhydraat_baw" value="{{ old('koolhydraat_baw') }}" placeholder="ex: Koolhydraat">
                                            <span class="text-danger" id="Koolhydraten_baw-error"></span>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label for="vezel_baw">Vezel</label>
                                            <input type="number" min="0" name="vezel_baw" class="form-control" id="vezel_baw" placeholder="ex: Vezel" value="{{ old('vezel_baw') }}">
                                            <span class="text-danger" id="vezel_baw-error"></span>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label for="vet_baw">Vet</label>
                                            <input type="number" min="0" name="vet_baw" class="form-control" id="vet_baw" placeholder="ex: vet"  value="{{ old('vet_baw') }}">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            ...
                                            <textarea name="daily_note" class="form-control" id="daily_note" placeholder="ex: Daily Note">  {{ old('daily_note') }}</textarea>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-12">
                                            <button type="button" class="btn btn-default btn-flat pull-right" data-dismiss="modal">@lang('common.close')</button>
                            ...
                            <div id="daily_food_consumed" class="tab-pane ">
                                <form service="form" action="{{route('admin.user.food_used')}}" id="user_food_used_add" method="post" enctype="multipart/form-data" onsubmit="submitForm('user_food_used_add');">
                                    {{ csrf_field() }}
                                   <input type="hidden" name="user_id" value="{{$user->id }}">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-2">
                                            <label>Koolhydraten</label>
                                            <input type="number" name="koolhydraat_baw" min="0" class="form-control" id="koolhydraat_baw" value="{{ old('koolhydraat_baw') }}" placeholder="ex: Koolhydraten">
                            ...
                            <div id="overig" class="tab-pane">
                                <form service="form" action="{{route('admin.user.daily_values')}}" id="user_daily_values_add" method="post" enctype="multipart/form-data" onsubmit="submitForm('user_daily_values_add');" >
                                     <input type="hidden" name="user_id" value="{{$user->id }}">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <label>Datum</label>
                                            <input type="date" name="date" class="form-control" id="date" value="{{ old('date') }}" placeholder="ex: Datum">
                                            <span class="text-danger" id="date-error"></span>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="weight">Gewicht</label>
                                            <input type="number" min="0" name="weight" class="form-control" id="weight" placeholder="ex: Gewicht" value="{{ old('weight') }}">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" min="0" name="kcal" class="form-control" id="kcal" value="{{ old('kcal') }}" placeholder="ex: Uw gebruikte Kcal">
                                            <span class="text-danger" id="kcal-error"></span>
                                        </div>
                                        <div class="form-group col-md-6">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="number" min="0" name="sleep_q1" class="form-control" id="sleep_q1" placeholder="ex: vet" value="{{ old('sleep_q1') }}">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <select name="sleep_q2" class="form-control" id="sleep_q2">
                                                <option value="1"
                                                 {{ old('sleep_q2')==1?'selected':'' }}>Ja</option>
                                                <option value="0"
                                                 {{ old('sleep_q2')==0?'selected':'' }}>Nee</option>
                                            </select>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <select name="sleep_q3" class="form-control" id="sleep_q3">
                                                <option value="1"
                                                 {{ old('sleep_q3')==1?'selected':'' }}>Ja</option>
                                                <option value="0"
                                                 {{ old('sleep_q3')==0?'selected':'' }}>Nee</option>
                                            </select>
                                        ...
                                        <div class="form-group col-md-6 sleep">
                                            ...
                                            <input type="text" name="sleep_q4" class="form-control" id="sleep_q4" placeholder="ex: vet" value="{{ old('sleep_q4') }}">
...
@section('site_scripts')
 @include('admin.scripts.user_dashboard_js')
@endsection
@section('script')
@endsection
