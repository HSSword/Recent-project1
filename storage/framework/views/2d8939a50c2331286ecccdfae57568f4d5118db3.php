 ...
 // var range_map = $.range_map({
  ...
  // })
    ...
    <?php for($i = 0; $i < count($sectionData['sleepdates']); $i++): ?> 
        if( $('#sparklineBar<?php echo e($i); ?>').get(0) ) {
            var sparklineBarData = [<?php echo e($sectionData['kcalvals'][$i]); ?>,<?php echo e($sectionData['weightvals'][$i]); ?>, <?php echo e($sectionData['sleepvals'][$i]); ?> ];

            $("#sparklineBar<?php echo e($i); ?>").sparkline(sparklineBarData, {
                type: 'bar',
                //width: '100',
                height: '30',
                //colorMap: range_map,
    ...
    <?php endfor; ?>
        ...
        $(".user-view-button").click(function () {
            ...
            $.ajax({
                ...
                dataType: "json",
                success: function (data) {
                    var src = '<?php echo e(asset('public/avatar')); ?>/';
                    var default_avatar = '<?php echo e(asset('public/avatar/user.png')); ?>';
