                                    ...
                                    <form service="form" id="service_add_form" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="days"><?php echo app('translator')->getFromJson('common.diensten_label'); ?></label>
                                                        <div class="input-group">
                                                            <span class="input-group-addon">
                                                                <i class="fa fa-calendar"></i>
                                                            </span>
                                                            <input type="text" name="service" class="form-control" id="service" value="<?php echo e(old('service')); ?>" placeholder="<?php echo app('translator')->getFromJson('common.service_name_plchldr'); ?>">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="days"><?php echo app('translator')->getFromJson('common.diensten_prijs_label'); ?></label>
                                                        <div class="input-group">
                                                            <span class="input-group-addon">
                                                                <i class="fa fa-calendar"></i>
                                                            </span>
                                                            <input type="text" name="sprice" class="form-control" id="sprice" value="<?php echo e(old('sprice')); ?>" placeholder="<?php echo app('translator')->getFromJson('common.part_credits_plchldr'); ?>">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="days"><?php echo app('translator')->getFromJson('common.maximaal_gebruikers_label'); ?></label>
                                                        <div class="input-group">
                                                            <span class="input-group-addon">
                                                                <i class="fa fa-calendar"></i>
                                                            </span>
                                                            <input type="text" name="user_mass" class="form-control" id="user_mass" value="<?php echo e(old('user_mass')); ?>" placeholder="<?php echo app('translator')->getFromJson('common.members_can_participate_plchldr'); ?>">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="text" name="payment_time" class="form-control" id="payment_time" value="<?php echo e(old('payment_time')); ?>" placeholder="<?php echo app('translator')->getFromJson('common.no_of_mins_plchldr'); ?>">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <select class="form-control" name="company_id" id="cname">
                                                                <option selected disabled><?php echo app('translator')->getFromJson('common.select_one_plchldr'); ?></option>
                                    ...
                                    <form role="form" id="package_add_form" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="days" class="form-control" id="days" value="<?php echo e(old('days')); ?>" placeholder="ex: days">
                                                <span class="text-danger" id="days-error"></span>
                                            </div>
                                            <div class="form-group">
                                                <label for="credits">Prijs</label>
                                                <input type="text" name="credits" class="form-control" id="credits" value="<?php echo e(old('credits')); ?>" placeholder="ex: Credits">
                                                <span class="text-danger" id="credits-error"></span>
                                            </div>
                                            <div class="form-group">
                                                <label for="pro_rato">Pro Rato</label>
                                                <input type="text" name="pro_rato" class="form-control" id="pro_rato" value="<?php echo e(old('pro_rato')); ?>" placeholder="ex: Pro Rato">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="Start_fee" class="form-control" id="Start_fee" value="<?php echo e(old('Start_fee')); ?>" placeholder="ex: Opstartkosten">
                                                <span class="text-danger" id="Start_fee-error"></span>
                                            </div>
                                            <div class="form-group">
                                                <label for="entree">Toegang</label>
                                                <input type="text" name="entree" class="form-control" id="entree" value="<?php echo e(old('entree')); ?>" placeholder="ex: Toegang">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="sell_category" class="form-control" id="sell_category-title" placeholder="ex: sell_category"><?php echo e(old('sell_category')); ?></textarea>
...
<?php $__env->startSection('site_scripts'); ?>
	<!-- Specific Page Vendor -->
        ...
        <script type="text/javascript" src="<?php echo e(asset('public/admin/datatable/js/buttons.colVis.min.js')); ?>"></script>   <script src="<?php echo e(asset('user_files/js/admin.js')); ?>"></script>
    ...
    <script type="text/javascript">
        ...
        $.get("<?php echo e(route('admin.dashboardGraph',['startdate'=>date('Y-m-d',strtotime('-6 days')),'enddate'=>date('Y-m-d'),'type'=>'invoice'])); ?>", function(data, status){
