        ...
        <div class="nano-content">
            <nav id="menu" class="nav-main" role="navigation">
                <ul class="nav nav-main">
                    ...
                    ?>
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('check-route', $route)): ?>
                    <li class="nav-active">
                        <a class="nav-link" href="<?php echo e(route($route)); ?>">
                    ...
                    <?php if($user->role != "user"): ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('check-route', 'admin.userIndexRoute')): ?>
                        <?php if($user->role == "admin"): ?>
                        <li class="nav-active">
                            <a class="nav-link" href="<?php echo e(route('admin.userIndexRoute')); ?>">
                        ...
                        <?php endif; ?>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('check-route', 'admin.packages.index')): ?>
                        <li>
                        ...
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('check-route', 'admin.tests.index')): ?>
                        <li>
                        ...
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('check-route', 'admin.companys.index')): ?>
                        <?php if($user->role == "admin"): ?>
                        <li>
                            <a href="<?php echo e(route('admin.companys.index')); ?>">
                            <i class="fa fa-building-o"></i>
                             <span>Bedrijven</span></a>
                        </li>
                        <?php endif; ?>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('check-route', 'admin.services.index')): ?>
                        <li>
                        ...
                        <?php endif; ?>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('check-route', 'admin.productsRqst')): ?>
                          <?php if($user->role == "admin" || $user->role == "company"): ?>
                                <li>


                                    <a href="<?php if(isset($user->products_default_setting)): ?> /<?php echo e($user->products_default_setting); ?> <?php else: ?> <?php echo e(route('admin.productsRqst')); ?> <?php endif; ?>">
                                        <i class="fa fa-superpowers"></i>
                                        <span>Kassa</span></a>
                                </li>
                            <?php endif; ?>
                        <?php endif; ?>
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('check-route', 'admin.exercisesViewRqst')): ?>
                        
                            <?php if($user->role == "admin" || $user->role == "company"): ?>
                                <li>
                                    <a href="<?php echo e(route('admin.exercisesViewRqst')); ?>">
                        ...
                        <?php endif; ?>
                                <li>
                                    ...
                                    <a href="/admin/rooster/<?php echo e($user->id); ?>/<?php echo e($serviceschedule_id); ?>/<?php echo e($date); ?>">
