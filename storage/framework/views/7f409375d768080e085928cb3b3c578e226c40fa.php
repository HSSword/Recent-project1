                    ...
                    <div class="tabs tabs-dark">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="nav-item tab-delete">
                                <a class="nav-link" id="delete-tab-button"><?php echo app('translator')->getFromJson('common.delete'); ?> </a>
                            </li>
                        </ul>
                                ...
                                <form role="form" id="role_add_form" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="role" class="form-control" id="role" value="<?php echo e(old('role')); ?>" placeholder="ex: days">
                                            <span class="text-danger" id="role-error"></span>
                                        </div>
                                        <div class="form-group">
                                            <label for="sell_category">Functie omschrijving</label>
                                            <textarea name="rdescription" class="form-control" id="rdescription" placeholder="ex: rdescription"><?php echo e(old('rdescription')); ?></textarea>
                ...
                <div class="col">
                    <div class="tabs tabs-dark">
                        <ul class="nav nav-tabs">
                            ...
                            <li class="nav-item tab-delete">
                                <a class="nav-link" id="delete-permission-tab-button"><?php echo app('translator')->getFromJson('common.delete'); ?> </a>
                            </li>
                        </ul>
                                ...
                                <form permission="form" id="permission_add_form" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="permission" class="form-control" id="permission" value="<?php echo e(old('permission')); ?>" placeholder="ex: permission">
                                            <span class="text-danger" id="permission-error"></span>
                                        </div>
                                        <div class="form-group">
                                            <label for="route_name">Route Name</label>
                                            <input type="text" name="route_name" class="form-control" id="route_name" value="<?php echo e(old('route_name')); ?>" placeholder="ex: Route Name">
                                            <span class="text-danger" id="route_name-error"></span>
                                        </div>
                                        <div class="form-group">
                                            <label for="days">Block Name</label>
                                            <input type="text" name="block_name" class="form-control" id="block_name" value="<?php echo e(old('block_name')); ?>" placeholder="ex: block name">
                                            <span class="text-danger" id="block_name-error"></span>
                                        </div>
                                        <div class="form-group">
                                            <label for="days">Dependent Route</label>
                                            <input type="text" name="dependent_routes" class="form-control" id="dependent_routes" value="<?php echo e(old('dependent_routes')); ?>" placeholder="ex: Dependent Route">
                                            <span class="text-danger" id="dependent_routes-error"></span>
                                        </div>
                                        <div class="form-group">
                                            <label for="sell_category">Toestemming omschrijving</label>
                                            <textarea name="pdescription" class="form-control" id="pdescription" placeholder="ex: pdescription"><?php echo e(old('pdescription')); ?></textarea>
                                ...
                                <form permission="form" id="permission_edit_form" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="route_name" class="form-control" id="edit-route_name" value="<?php echo e(old('route_name')); ?>" placeholder="ex: Route Name">
                                            <span class="text-danger" id="edit-route_name-error"></span>
                                        </div>
                                        <div class="form-group">
                                            <label for="days">Block Name</label>
                                            <input type="text" name="block_name" class="form-control" id="edit-block_name" value="<?php echo e(old('block_name')); ?>" placeholder="ex: block name">
                                            <span class="text-danger" id="edit-block_name-error"></span>
                                        </div>
                                        <div class="form-group">
                                            <label for="days">Dependent Route</label>
                                            <input type="text" name="dependent_routes" class="form-control" id="edit-dependent_routes" value="<?php echo e(old('dependent_routes')); ?>" placeholder="ex: Dependent Route">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-default btn-flat pull-left" data-dismiss="modal"><?php echo app('translator')->getFromJson('common.close'); ?></button>
                                        <button type="button" class="btn btn-info btn-flat update-permission-button"><?php echo app('translator')->getFromJson('common.update'); ?></button>
                                    </div>
                                </form>
                            </div>
                        </div>
...
<div id="add-permission-modal" class="modal fade bs-example-modal-lg" tabindex="-1" permission="dialog" aria-labelledby="myLargeModalLabel">
    ...
    <div class="modal fade bulk-delete-modal" id="delete-role-modal-bulk" role="dialog">
        <div class="modal-dialog">
          <div class="modal-content">
             <form method="GET" action="<?php echo e(url('admin/bulk-delete/roles')); ?>" id="delete-role-form-bulk">
            <div class="modal-header">
    ...
    <div class="modal fade bulk-delete-modal" id="delete-permission-modal-bulk" role="dialog">
        <div class="modal-dialog">
          <div class="modal-content">
             <form method="GET" action="<?php echo e(url('admin/bulk-delete/permissions')); ?>" id="delete-permission-form-bulk">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body" style="text-align: center;">
