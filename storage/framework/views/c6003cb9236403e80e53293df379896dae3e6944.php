					...
					<!-- added by other end  -->
						<div class="col-md-12 inner-dashborad-block" style="padding: 10px;">
								...
								<div class="col-xl-3 block-row ">
								    <!-- <?php $block_image_1 = Helper::getSiteImage('banner'); ?> -->

									<section class="card card-featured-left card-featured-secondary hvr-grow-shadow">
										<div class="card-body">
											<div class="widget-summary">
												<i class="fa fa-edit fa-stack-1x icon-edit" data-id="<?php echo e($block_image_1->id); ?>" data-block_id="dashboard_block_1" ></i>
												<div class="widget-summary-col widget-summary-col-icon">
													<div class="summary-icon bg-primary">
														<!-- <img src="<?php echo e(asset('site_images')); ?>/<?php echo e($block_image_1->src); ?>" alt="Joseph Doe Junior" class="rounded-circle" id="dashboard_block_1"> -->
													</div>
												</div>
												<div class="widget-summary-col">
													...
													<a href="<?php echo e(url('admin/users')); ?>">
														<div class="summary">
															...
															<div class="info">
																<strong class="amount"><?php echo e(isset($total_users) ? $total_users : ''); ?></strong>
																<!-- <span class="text-primary">(14 unread)</span> -->
															</div>
														</div>
													</a>
													<!-- <div class="summary-footer">
														<a class="text-muted text-uppercase" href="<?php echo e(url('admin/users')); ?>">(view all)</a>
													</div> -->
												</div>
											</div>
										</div>
								...
								<div class="col-xl-3 block-row">
								<!-- <?php $block_image_2 = Helper::getSiteImage('banner'); ?> -->
									<section class="card card-featured-left card-featured-secondary hvr-grow-shadow">
										<div class="card-body">
											<div class="widget-summary">
											<i class="fa fa-edit fa-stack-1x icon-edit" data-id="<?php echo e($block_image_2->id); ?>" data-block_id="dashboard_block_2" ></i>
												<div class="widget-summary-col widget-summary-col-icon">
													<div class="summary-icon bg-secondary">
													<!-- <img src="<?php echo e(asset('site_images')); ?>/<?php echo e($block_image_2->src); ?>" alt="Joseph Doe Junior" class="rounded-circle" id="dashboard_block_2"> -->
													</div>
												</div>
												<div class="widget-summary-col">
													<a href="<?php echo e(route('admin.packages.index', ['finance' => 'finance_tab'])); ?>">
														<div class="summary">
															<h4 class="title">Omzet deze maand</h4>
															<div class="info">
																<strong class="amount">€ <?php echo e(isset($turnover_this_month) ? $turnover_this_month : '0'); ?></strong>
															</div>
														</div>
													</a>
												<!-- 	<div class="summary-footer">
														<a class="text-muted text-uppercase" href="<?php echo e(route('admin.packages.index', ['finance' => 'finance_tab'])); ?>">(withdraw)</a>
													</div> -->
												</div>
											</div>
										</div>
								...
								<!-- <?php $block_image_3 = Helper::getSiteImage('banner'); ?> -->
									<section class="card card-featured-left card-featured-secondary">
										<div class="card-body">
											<div class="widget-summary">
											<i class="fa fa-edit fa-stack-1x icon-edit" data-id="<?php echo e($block_image_3->id); ?>" data-block_id="dashboard_block_3" ></i>
												<div class="widget-summary-col widget-summary-col-icon">
													<div class="summary-icon bg-tertiary">
												        	<!-- <img src="<?php echo e(asset('site_images')); ?>/<?php echo e($block_image_3->src); ?>" alt="Joseph Doe Junior" class="rounded-circle" id="dashboard_block_3"> -->
													</div>
												</div>
												<div class="widget-summary-col">
													<a href="<?php echo e(route('admin.userIndexRoute', ['check_in' => 'check_in_tab'])); ?>">
														<div class="summary">
															<h4 class="title">Bezoeken vandaag</h4>
															<div class="info">
																<strong class="amount"><?php echo e($check_in_count); ?></strong>
															</div>
														</div>
													</a>
								...
								<div class="col-xl-3 block-row hvr-grow-shadow">
								<!-- <?php $block_image_4 = Helper::getSiteImage('banner'); ?> -->
									<section class="card card-featured-left card-featured-quaternary">
										<div class="card-body">
											<div class="widget-summary">
										<i class="fa fa-edit fa-stack-1x icon-edit" data-id="<?php echo e($block_image_4->id); ?>" data-block_id="dashboard_block_4" ></i>
												<div class="widget-summary-col widget-summary-col-icon">
													<div class="summary-icon bg-quaternary">
														<!-- <img src="<?php echo e(asset('site_images')); ?>/<?php echo e($block_image_4->src); ?>" alt="Joseph Doe Junior" class="rounded-circle" id="dashboard_block_4"> -->
													</div>
												</div>
												<div class="widget-summary-col">
													<a href="<?php echo e(url('/admin/users')); ?>">
														<div class="summary">
															...
															<div class="info">
																<strong class="amount"><?php echo e(isset($today_login_users) ? $today_login_users : ''); ?></strong>
															</div>
														</div>
													</a>
													<!-- <div class="summary-footer">
														<a class="text-muted text-uppercase" href="<?php echo e(url('/admin/users')); ?>">(report)</a>
													</div> -->
												</div>
											</div>
										</div>
														...
														<section class="card">
															<div class="card-body">
															   ...
															   <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
														    	<button type="button" class="mb-1 mt-1 mr-1 btn btn-primary" style=""><?php echo e($product->name); ?></button>
														    	<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
													...
													<div class="card-body">
														<section class="card">
															<div class="	card-body">
														    	...
														    	<button type="button" class="mb-1 mt-1 mr-1 btn btn-primary" style="background:<?php echo e($service->bg_color); ?>"><?php echo e($service->service); ?></button>
														    	<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
									   ...
									   <!-- tab1 -->
											...
											<section class="card">
												<div class="card-body">
													<ul class="simple-user-list">
														...
														<?php $__currentLoopData = $check_in_log; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $check): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
														<li class="<?php if($check['checkremain'] < 2): ?> bg-warning <?php else: ?> bg-success <?php endif; ?>">
															<figure class="image rounded">
																<img src="<?php echo e(asset('admin_files/img/!sample-user.jpg')); ?>" alt="<?php echo e($check['username']); ?>" class="rounded-circle">
															</figure>
															<span class="title"><?php echo e($check['username']); ?></span>
															<span class="message truncate">Checked in at <?php echo e($check['checkDate']); ?></span>
														</li>
														<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
										...
										<div id="message2" class="tab-pane">
											<section class="card">
												<div class="card-body">
													<ul class="simple-user-list">
														<?php $__currentLoopData = getLogByLogName('common.check_in'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
														<li class="msg-0">
															<figure class="image rounded">
																<img src="<?php echo e(asset('admin_files/img/!sample-user.jpg')); ?>" alt="Joseph Doe Junior" class="rounded-circle">
															</figure>
															<span class="title"><?php echo e(getUserNameById($log->causer_id)); ?></span>
															<span class="message truncate">Logged in at <?php echo e($log->created_at); ?></span>
														</li>
														<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
															</ul>
													<hr class="dotted short">
													<?php echo e(getLogByLogName('common.check_in')->links()); ?>
											...
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														...
														<div class="col-sm-12 num-txt"><?php echo e($data['totalUsers']); ?></div>
													</div>
												</div>
											</div>
										</div>
											...
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														...
														<div class="col-sm-12 num-txt"><?php echo e($data['currentUsers']); ?></div>
													</div>
												</div>
											</div>
										</div>
											...
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														...
														<div class="col-sm-12 num-txt"><?php echo e($data['diffUsers']); ?></div>
													</div>
												</div>
											</div>
										</div>
											...
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														...
														<div class="col-sm-12 num-txt"><?php echo e($data['diffPercentage']); ?>%</div>
												</div>
											</div>
										</div>
									</section>
											...
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														...
														<div class="col-sm-12 num-txt"><?php echo e($data['lastMonthNew']); ?></div>
												</div>
											</div>
										</div>
									</section>
											...
											<div class="widget-summary">
												...
												<div class="widget-summary-col">
													<div class="summary">
														...
														<div class="col-sm-12 num-txt"><?php echo e($data['lastMonthBlocked']); ?>%</div>
												</div>
											</div>
										</div>
									</section>
...
<?php $__env->startSection('site_scripts'); ?>
	...
	<script src="<?php echo e(asset('admin_files/vendor/jquery-appear/jquery-appear.js')); ?>"></script>
	<script src="<?php echo e(asset('admin_files/vendor/bootstrap-multiselect/bootstrap-multiselect.js')); ?>"></script>
	<script src="<?php echo e(asset('admin_files/vendor/jquery.easy-pie-chart/jquery.easy-pie-chart.js')); ?>"></script>
	<script src="<?php echo e(asset('admin_files/vendor/flot/jquery.flot.js')); ?>"></script>
	<script src="<?php echo e(asset('admin_files/vendor/flot.tooltip/flot.tooltip.js')); ?>"></script>
	<script src="<?php echo e(asset('admin_files/vendor/flot/jquery.flot.pie.js')); ?>"></script>
	<script src="<?php echo e(asset('admin_files/vendor/flot/jquery.flot.categories.js')); ?>"></script>
	<script src="<?php echo e(asset('admin_files/vendor/flot/jquery.flot.resize.js')); ?>"></script>
	<script src="<?php echo e(asset('admin_files/vendor/jquery-sparkline/jquery-sparkline.js')); ?>"></script>
	<script src="<?php echo e(asset('admin_files/vendor/raphael/raphael.js')); ?>"></script>
	<script src="<?php echo e(asset('admin_files/vendor/morris/morris.js')); ?>"></script>
	<script src="<?php echo e(asset('admin_files/vendor/gauge/gauge.js')); ?>"></script>
	<script src="<?php echo e(asset('admin_files/vendor/snap.svg/snap.svg.js')); ?>"></script>
	<script src="<?php echo e(asset('admin_files/vendor/liquid-meter/liquid.meter.js')); ?>"></script>
	<script src="<?php echo e(asset('admin_files/vendor/jqvmap/jquery.vmap.js')); ?>"></script>
	<script src="<?php echo e(asset('admin_files/vendor/jqvmap/data/jquery.vmap.sampledata.js')); ?>"></script>
	<script src="<?php echo e(asset('admin_files/vendor/jqvmap/maps/jquery.vmap.world.js')); ?>"></script>
	<script src="<?php echo e(asset('admin_files/vendor/jqvmap/maps/continents/jquery.vmap.africa.js')); ?>"></script>
	<script src="<?php echo e(asset('admin_files/vendor/jqvmap/maps/continents/jquery.vmap.asia.js')); ?>"></script>
	<script src="<?php echo e(asset('admin_files/vendor/jqvmap/maps/continents/jquery.vmap.australia.js')); ?>"></script>
	<script src="<?php echo e(asset('admin_files/vendor/jqvmap/maps/continents/jquery.vmap.europe.js')); ?>"></script>
	<script src="<?php echo e(asset('admin_files/vendor/jqvmap/maps/continents/jquery.vmap.north-america.js')); ?>"></script>
	<script src="<?php echo e(asset('admin_files/vendor/jqvmap/maps/continents/jquery.vmap.south-america.js')); ?>"></script>
...
function lineGraph(graphid,data, options,colors=[]) {
	...
	$(document).ready(function(){
		...
		var graph_users=<?php echo json_encode($graph_users); ?>;
		var graph_products=<?php echo json_encode($graph_products); ?>;
		var graph_services=<?php echo json_encode($graph_service); ?>;
...
$('.charts-tabs a[data-toggle="tab"]').on('shown.bs.tab', function (e) {
	...
	if(chart_ ==  "ChartistSimpleLineChart4"){
		lineGraph('ChartistSimpleLineChart4',<?php echo json_encode($graph_invoices); ?>,null);
	}
