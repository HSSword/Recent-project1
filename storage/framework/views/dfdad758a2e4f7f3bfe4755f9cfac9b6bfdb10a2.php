  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <input type="hidden" name="_token" id="tokenn" value="<?php echo e(csrf_token()); ?>">
      ...
      <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-info btn-flat update-button"><?php echo app('translator')->getFromJson('common.update'); ?></button>
              </div>
       </form>
    </div>
        ...
        <div class="modal-content">
          <div class="modal-header" style="display: block;">
            ...
            <form role="form" >
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-default btn-flat pull-left" data-dismiss="modal"><?php echo app('translator')->getFromJson('common.close'); ?></button>
                <button type="button" class="btn btn-info btn-flat upload-cropeie-result"><?php echo app('translator')->getFromJson('common.update'); ?></button>
              </div>
