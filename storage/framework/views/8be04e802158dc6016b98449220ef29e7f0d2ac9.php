...
<?php $__env->startSection('title','Attach Permission'); ?>
								...
								<table class="table table-bordered table-striped mb-0" id="datatable-attachpermission" >
									...
									<tbody>
										...
										<tr>
											<td>
												<label class="switch">
												  <input type="checkbox" <?php echo e($isChecked); ?> name="permissionsId[]" value="<?php echo e($permission->id); ?>" roleid=<?php echo e($roleId); ?> class="permissionCheck">
												  <span class="slider round"></span>
												</label>
											</td>
											<td><?php echo e($permission->permission); ?></td>
											<td><?php echo e($permission->pdescription); ?></td>
										</tr>
										<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
									</tbody>
...
$(document).ready(function(){
    $(".permissionCheck").change(function(){
        ...
        $.ajax({
                type: "POST",
                url: '<?php echo e(route('admin.role.permissions.setP')); ?>',
                data: { permissionid: permissionVal,roleid:roleVal,action:action,userid:userId,_token: '<?php echo e(csrf_token()); ?>'},
                dataType: 'json',
