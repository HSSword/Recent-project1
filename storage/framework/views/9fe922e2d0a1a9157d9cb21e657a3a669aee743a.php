...
<?php $__env->startSection('content'); ?>
			...
			<div class="col">
				<div class="tabs tabs-dark">
					...
					<div class="tab-content">
						<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('check-block', 'companys.tab1')): ?>
						...
						<?php endif; ?>
						<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->denies('check-block', 'companys.tab1')): ?>
	...
	<!-- /.delete page modal -->
	  <div class="modal fade" id="delete-modal-bulk" role="dialog">
	    <div class="modal-dialog">
	      <div class="modal-content">
	         <form method="POST" action="<?php echo e(route('admin.company.bulkdelete')); ?>" id="delete-from-bulk">
	        <div class="modal-header">
...
var select_html = '<a href="<?php echo e(route('admin.newCompanysRoute')); ?>" class="btn  btn-force btn-info btn-md hvr-grow-shadow pull-right"><?php echo app('translator')->getFromJson('common.add_company'); ?></a><div class="pull-right"><span style="width:auto;line-height:2.5;padding:0;"> Filter op </span> <select class="form-control" >';
	...
	var datatableInit = function() {
		...
		var table = $table.dataTable({
		    bDestroy: true,
			ajax: "<?php echo e(route('admin.getCompanysRoute')); ?>",
			dom: 'Bfrtip',
			buttons: [
			{
...
function remove(company_id){
    var url = "<?php echo e(route('admin.companys.destroy', 'company_id')); ?>";
