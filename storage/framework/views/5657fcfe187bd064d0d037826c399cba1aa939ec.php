    ...
    <div class="row">
        <section class="card col-md-12">
            <div class="card-body">
                ...
                <form id="profile_edit_form" data-parsley-validate class="form-horizontal" action="<?php echo e(route('admin.tests.update',$test->id)); ?>" method="post">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                           ...
                           <div class="input-group">
                                ...
                                <input type="text" name="test_name" class="form-control" id="test_name" value="<?php echo e($test->test_name); ?>">
                            </div>
                        </div>
                           ...
                           <div class="input-group">
                                ...
                                <select name="company_id" class="form-control">
                                    ...
                                    <?php $__currentLoopData = $companies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($c->id); ?>" <?php echo e(old('company_id')?(e(old('company_id'))==$c->id?'selected':''):($test->test_name==$c->id?'selected':'')); ?>
                       ...
                       <?php endif; ?>
                        <div class="form-group col-md-12">
                           ...
                           <div class="input-group">
                                <textarea name="description" class="form-control" id="description" ><?php echo e($test->description); ?></textarea>
                             </div>
                        </div>
                        <div class="form-group col-md-12">
                           ...
                           <div class="input-group">
                                ...
                                <select name="status" class="form-control">
                                    <option value="1" <?php echo e($test->status?'selected':''); ?>>Active</option>
                                    <option value="0" <?php echo e($test->status?'':'selected'); ?>>Inactive</option>
                                </select>
                            </div>
                        </div>
...
<?php $__currentLoopData = $test->questions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ques): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    var obj;
    obj = {
        'id': "<?php echo e($ques->id); ?>",
        'question':"<?php echo e($ques->question); ?>",
        'type': "<?php echo e($ques->type); ?>",
        'show_graph': "<?php echo e($ques->show_graph); ?>"
    };
    appenddata.push(obj);
