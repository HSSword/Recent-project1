                        ...
                        <div class="col-lg-4 col-xl-3 mb-4 mb-xl-0">
                            <section class="card">
                                <div class="card-body">
                                    ...
                                    <i class="fa fa-edit fa-stack-1x icon-edit" style="text-align: right;color: white;font-size: 20px;" data-id="<?php echo e($user->id); ?>" data-block_id="avatar"></i>
                                    <?php if(!empty($user->avatar)): ?>
                                        <img src="<?php echo e(asset('profile_images/')); ?>/<?php echo e($user->avatar); ?>" class="rounded img-fluid" id="avatar" alt="<?php echo e($user->first_name .' '. $user->surname); ?>">
                                    <?php else: ?>
                                        <img src="<?php echo e(asset('admin_files/img/!logged-user.jpg')); ?>" class="rounded img-fluid" id="avatar" alt="image">

                                    <?php endif; ?>
                                        <div class="thumb-info-title">
                                            <span class="thumb-info-inner"><?php echo e($user->first_name); ?> <?php echo e($user->surname); ?></span>
                                    ...
                                    <div class="widget-toggle-expand mb-3">
                                        ...
                                        <div class="widget-content-collapsed">
                                            ...
                                            <?php if ($incr > 25) { ?>
                                            <div class="progress-bar progress-bar-<?php echo e($stripColor); ?>" role="progressbar" aria-valuenow="<?php echo e($incr); ?>" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo e($incr); ?>%;">
                                                <?php echo e($incr); ?>%
                                                </div>
                                            <?php  } else { ?>
                                            <div class="progress-bar progress-bar-warning" role="progressbar" aria-valuenow="<?php echo e($incr); ?>" aria-valuemin="0" aria-valuemax="100" style="width: <?php echo e($incr); ?>%;">
                                                </div>
                                                <span style="text-align: right;float: right;display: block;margin-top: -5px;margin-left: 73px;color: #363535;"> <?php echo e($incr); ?>% </span>
                                            <?php } ?>
                                        </div>
                                    </div>
                                        <div class="widget-content-expanded">
                                            <ul class="simple-todo-list mt-3 user-info-block">
                                                <li class="completed"><strong>Email</strong> <span><?php echo e($user->email); ?></span></li>
                                                <li class="completed"><strong>Age</strong> <span>

                                                     <?php if($age = Helper::getAgeAttribute($user->age)): ?>
                                                     <?php echo e($age); ?> year old
                                                     <?php else: ?>
                                                      Less then a year
                                                     <?php endif; ?>
                                                ...
                                                <?php echo e(($user->gender == 'm')?'Man':'Vrouw'); ?>

                                                 </span></li>
                                                <li class="completed"><strong>Telefoonnummer</strong> <span>9876543210</span></li>
                                                <li class="completed"><strong>Role</strong> <span><?php echo e($user->role); ?></span></li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <p class="text-2"><?php echo e($user->about); ?></p>
                                    <div class="clearfix">
                                ...
                                <div class="tab-content">
                                        ...
                                        <form id="profile_edit_form" data-parsley-validate class="form-horizontal" action="" method="post">
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                   ...
                                                   <div class="input-group">
                                                        ...
                                                        <input type="text" name="first_name" class="form-control" id="name" value="<?php echo e($user->first_name); ?>" placeholder="ex. John Smith">
                                                ...
                                                <div class="form-group col-md-6">
                                                   ...
                                                   <div class="input-group">
                                                       <span class="input-group-addon">
                                                        ...
                                                        <input type="text" name="surname" class="form-control" id="surname" value="<?php echo e($user->surname); ?>"  placeholder="ex. john_smith">
                                                        <span class="text-danger role-error"></span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" name="email" class="form-control" id="copyright" value="<?php echo e($user->email); ?>" placeholder="ex. johnsmith@mail.com">
                                                    <span class="text-danger role-error"></span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group col-md-6" >
                                                    ...
                                                    <select name="gender" class="form-control" id="gender" >
                                                        ...
                                                        <option value="m" <?php echo e((($user->gender == 'm')?'selected=true':'')); ?>>Man</option>
                                                        <option value="f" <?php echo e((($user->gender == 'f')?'selected=true':'')); ?>>Vrouw</option>
                                                    </select>
                                                    <span class="text-danger role-error"></span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                   ...
                                                   <div class="input-group">
                                                    ...
                                                    <input type="text" name="phone" class="form-control" id="phone" value="<?php echo e($user->phone); ?>" placeholder="ex. XXXXXXXXXXX">
                                                    <span class="text-danger role-error"></span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <input  type="text" id="userBirthDay" name="birthday" value="<?php echo e($user->birthday); ?>" class="form-control" placeholder="dd.mm.yyyy">
                                                        <span class="text-danger role-error"></span>
                                                        </div>
                                                </div>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="iban" class="form-control" id="iban" value="<?php echo e($user->iban); ?>" placeholder="ex. NL11ABCD1234567890" >
                                                    <span class="text-danger role-error"></span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group col-md-6">
                                                   ...
                                                   <div class="input-group">
                                                    ...
                                                    <input type="text" name="taal" class="form-control" id="taal" value="<?php echo e($user->taal); ?>" placeholder="ex. Dutch">
                                                    <span class="text-danger role-error"></span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="input-group">
                                                       <span class="input-group-addon">
                                                        ...
                                                        <input  type="text" id="klant_sinds" name="klant_sinds" value="<?php echo e($user->klant_sinds); ?>" class="form-control" placeholder="dd.mm.yyyy">
                                                        <span class="text-danger role-error"></span>
                                                        </div>
                                                </div>
                                               ...
                                               <div class="form-group col-md-6">
                                                    ...
                                                    <input type="text" name="address" class="form-control" id="address" value="<?php echo e($user->address); ?>" placeholder="ex. House 00, Road 00, New york, United states">
                                                    <span class="text-danger role-error"></span>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="about">Over mezelf</label>
                                                    ...
                                                    <textarea name="about" class="form-control" id="about" rows="6" placeholder="ex. about me" ><?php echo e($user->about); ?></textarea>
                                                    <span class="text-danger role-error"></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select class="form-control" name="role" id="edit-role">
                                                        ...
                                                        <option value="admin" <?php echo e((($user->role == 'admin')?'selected=true':'')); ?>>Admin</option>
                                                        <option value="user" <?php echo e((($user->role == 'user')?'selected=true':'')); ?>>User</option>
                                                        <option value="company" <?php echo e((($user->role == 'company')?'selected=true':'')); ?>>Company</option>
                                                    </select>
                                                    <span class="text-danger role-error"></span>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group col-md-6">
                                                  ...
                                                  <div class="input-group">
                                                    ...
                                                    <select class="form-control" name="activation_status" id="activation_status">
                                                            <option selected disabled>Select One</option>
                                                            <option value="1" <?php echo e((($user->activation_status == '1')?'selected=true':'')); ?>>Active</option>
                                                            <option value="0" <?php echo e((($user->activation_status == '0')?'selected=true':'')); ?>>Block</option>
                                                        </select>
                                                     <span class="text-danger role-error"></span>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="tab-pane" id="coaching">
                                        ...
                                        <form  id="coaching_edit_form" data-parsley-validate class="form-horizontal"
                                               action="<?php echo e(route('admin.profileupdatecoachingRqst', $user->id)); ?>"
                                               method="post">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text"  name="hoofddoel" class="form-control" id="hoofddoel"
                                                               value="<?php echo e($user->hoofddoel); ?>" placeholder="ex. John Smith" required>
                                                    ...
                                                    <div class="input-group">
                                                       <span class="input-group-addon">
                                                        ...
                                                        <input type="text" name="letsels" class="form-control" id="letsels"
                                                               value="<?php echo e($user->letsels); ?>" placeholder="Letsels"
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="chronischeziekte" class="form-control" id="copyright"
                                                               value="<?php echo e($user->chronischeziekte); ?>" placeholder="Chronische Ziekte"
                                                    ...
                                                    <div class="input-group">
                                                       <span class="input-group-addon">
                                                        ...
                                                        <input type="text" name="noodcontact" class="form-control" id="copyright"
                                                               value="<?php echo e($user->noodcontact); ?>" placeholder="Noodcontact"
                                                               required maxlength="100">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="meerinformatie" class="form-control" id="copyright"
                                                               value="<?php echo e($user->meerinformatie); ?>" placeholder="Meer informatie"
                                                               required maxlength="100">
                                                    ...
                                                    <div class="input-group">
                                                       <span class="input-group-addon">
                                                        ...
                                                        <input type="text" name="telefoonnummernood" class="form-control" id="telefoonnummernood"
                                                               value="<?php echo e($user->telefoonnummernood); ?>" placeholder="ex. XXXXXXXXXXX"
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="checkin_text_accept" class="form-control" id="checkin_text_accept"
                                                               value="<?php echo e($user->checkin_text_accept); ?>" placeholder="Checkin_text_accept"
                                                               maxlength="250">
                                                    ...
                                                    <div class="input-group">
                                                       <span class="input-group-addon">
                                                        ...
                                                        <input type="text" name="checkin_text_warning" class="form-control" id="checkin_text_warning"
                                                               value="<?php echo e($user->checkin_text_warning); ?>" placeholder="Checkin_text_warning"
                                                               maxlength="250">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="checkin_text_denied" class="form-control" id="checkin_text_denied"
                                                               value="<?php echo e($user->checkin_text_denied); ?>" placeholder="Checkin_text_denied"
                                                               maxlength="250">
...
<?php $__env->startSection('site_scripts'); ?>
     <?php echo $__env->make('admin.scripts.user_view_js', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
