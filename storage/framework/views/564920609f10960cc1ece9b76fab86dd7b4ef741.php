...
<!-- Specific Page Vendor CSS -->
		<link rel="stylesheet" type="text/css" href="<?php echo e(asset('admin_files/vendor/bootstrap-multiselect/bootstrap-multiselect.css')); ?>" />
...
<section role="main" class="content-body">
    ...
    <?php endif; ?>
		<div class="col">
			<div class="tabs tabs-dark">
				...
				<ul class="nav nav-tabs">
					<li class="nav-item <?php echo e(empty($finance) ? 'active' :''); ?>">
					...
					<li class="nav-item">
						<a class="nav-link <?php echo e(!empty($finance) ? 'active' : ''); ?>" href="#popular4" 
						data-toggle="tab">Finance</a>
					</li>
				</ul>

				<div class="tab-content">
					<div id="popular6" class="tab-pane <?php echo e(empty($finance) ? 'active' :''); ?>">
						<section class="card">
							<div class="card-body">
								<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('check-block', 'packages.tab1')): ?>
								...
								<?php endif; ?>
								<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->denies('check-block', 'packages.tab1')): ?>
					...
					<div id="popular5" class="tab-pane">
						<section class="card">
							<div class="card-body">
								<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('check-block', 'packages.tab2')): ?>
								...
								<?php endif; ?>
								<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->denies('check-block', 'packages.tab2')): ?>
								<b class="text-center">You are unauthorized for this tab.</b>
								<?php endif; ?>
							</div>
				        </section>
					</div>
					<div id="popular4" class="tab-pane <?php echo e(!empty($finance) ? 'active' : ''); ?>">
                        <section class="card">
                            <div class="card-body">
                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('check-block', 'packages.tab3')): ?>
                                ...
                                <?php endif; ?>
								<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->denies('check-block', 'packages.tab3')): ?>
								<b class="text-center">You are unauthorized for this tab.</b>
								<?php endif; ?>
                            </div>
                        </section>
	                ...
	                <div class="col">
	                    <div class="tabs tabs-dark">
	                        <ul class="nav nav-tabs">
	                            ...
	                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('check-route', 'admin.services.delete')): ?>
							    <li class="nav-item tab-delete">
	                                <a class="nav-link" id="delete-service-tab-button"><?php echo app('translator')->getFromJson('common.delete'); ?> </a>
	                            </li>
	                            <?php endif; ?>
	                        </ul>
	                        ...
	                        <div class="tab-content">
	                            ...
	                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('check-route', 'admin.services.add')): ?>
	                            	<form service="form" id="service_add_form" method="post" enctype="multipart/form-data">
						                ...
						                <div class="">
						                    <div class="form-group">
						                        ...
						                        <input type="text" name="service" class="form-control" id="service" value="<?php echo e(old('service')); ?>" placeholder="ex: Dagen">
						                        <span class="text-danger" id="service-error"></span>
						                    </div>
						                    <div class="form-group">
						                        <label for="sell_category">Omschrijving</label>
						                        <textarea name="sdescription" class="form-control" id="sdescription" placeholder="ex: sdescription"><?php echo e(old('sdescription')); ?></textarea>
						                        <span class="text-danger" id="sdescription-error"></span>
						                    </div>
						                    <div class="form-group">
						                        <label for="days">Diensten Prijs</label>
						                        <input type="text" name="sprice" class="form-control" id="sprice" value="<?php echo e(old('sprice')); ?>" placeholder="ex: Dagen">
						                        <span class="text-danger" id="sprice-error"></span>
						                    </div>
						                    <div class="form-group">
						                        <label for="days">Maximaal gebruikers</label>
						                        <input type="text" name="user_mass" class="form-control" id="user_mass" value="<?php echo e(old('user_mass')); ?>" placeholder="ex: Dagen">
						                        <span class="text-danger" id="user_mass-error"></span>
						                    </div>
						                    <div class="form-group">
						                        <label for="days">Hoever van tevoren wilt u de credits afschrijven</label>
						                        <input type="text" name="payment_time" class="form-control" id="payment_time" value="<?php echo e(old('payment_time')); ?>" placeholder="ex: Dagen">
						        ...
						        <?php endif; ?>
						        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->denies('check-route', 'admin.services.add')): ?>
								<b class="text-center">You are unauthorized for this tab.</b>
								<?php endif; ?>
	                            </div>
	                            <div id="update_service_tab_pane" class="tab-pane  tab-edit-pane active">
	                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('check-route', 'admin.services.edit')): ?>
									<form service="form" id="service_edit_form" method="post" enctype="multipart/form-data">
						                ...
						                <div class="modal-footer">
						                    <button type="button" class="btn btn-default btn-flat pull-left" data-dismiss="modal"><?php echo app('translator')->getFromJson('common.close'); ?></button>
						                    <button type="button" class="btn btn-info btn-flat update-button-service"><?php echo app('translator')->getFromJson('common.update'); ?></button>
						                </div>
						            </form>
						            <?php endif; ?>
							        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->denies('check-route', 'admin.services.edit')): ?>
									<b class="text-center">You are unauthorized for this tab.</b>
									<?php endif; ?>
	                ...
	                <div class="col">
	                    <div class="tabs tabs-dark">
	                        <ul class="nav nav-tabs">
	                            ...
	                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->denies('check-route', 'admin.packages.delete')): ?>
							    <li class="nav-item tab-delete">
	                                <a class="nav-link" id="delete-package-tab-button"><?php echo app('translator')->getFromJson('common.delete'); ?> </a>
	                            </li>
	                            <?php endif; ?>
	                        </ul>
	                        ...
	                        <div class="tab-content">
	                            <div id="add_package_tab_pane" class="tab-pane tab-add-pane">
	                            	<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('check-route', 'admin.packages.add')): ?>
									<form role="form" id="package_add_form" method="post" enctype="multipart/form-data">
										...
										<div class="">
											...
											<div class="row">	
												...
												<div class="form-group col-md-6">
													<label><?php echo app('translator')->getFromJson('common.services_label'); ?></label>
													<div class="input-group">
														<span class="input-group-addon">
											...
											<div class="row">
												<div class="form-group col-md-6">
													<label><?php echo app('translator')->getFromJson('common.role_label'); ?></label>
													<div class="input-group">
														<span class="input-group-addon">
															<i class="fa fa-send-o"></i>
														</span>
												...
												<div class="form-group col-md-6">
													<label for="days">
													<?php echo app('translator')->getFromJson('common.valid_days_label'); ?></label>
													<div class="input-group">
														<span class="input-group-addon">
															<i class="fa fa-pencil"></i>
														</span>
														<input type="text" name="days" class="form-control" id="days" value="<?php echo e(old('days')); ?>" placeholder="<?php echo app('translator')->getFromJson('common.days_plchldr'); ?>">
													</div>
											...
											<div class="row">
												<div class="form-group col-md-6">
													<label for="credits"><?php echo app('translator')->getFromJson('common.price_label'); ?></label>
													<div class="input-group">
														<span class="input-group-addon">
															<i class="fa fa-money"></i>
														</span>
														<input type="text" name="credits" class="form-control" id="credits" value="<?php echo e(old('credits')); ?>" placeholder="<?php echo app('translator')->getFromJson('common.enter_price'); ?>">
													</div>
													<span class="text-danger" id="credits-error"></span>
												</div>
												<div class="form-group col-md-6">
													<label for="pro_rato"><?php echo app('translator')->getFromJson('common.pro_rato_label'); ?></label>
													<div class="input-group">
														<span class="input-group-addon">
															<i class="fa fa-mars"></i>
														</span>
														<input type="text" name="pro_rato" class="form-control" id="pro_rato" value="<?php echo e(old('pro_rato')); ?>" placeholder="<?php echo app('translator')->getFromJson('common.pro_rato_plchldr'); ?>">
													</div>
											...
											<div class="row">
												<div class="form-group col-md-6">
													<label><?php echo app('translator')->getFromJson('common.auto_payment_mode_label'); ?></label>
													<div class="input-group">
														<span class="input-group-addon">
															<i class="fa fa-mars"></i>
														</span>
														<select class="form-control" name="expand_automatically" id="expand_automatically">
															<option selected disabled>Select One</option>
															<option value="1"><?php echo app('translator')->getFromJson('common.package_active'); ?></option>
															<option value="0"><?php echo app('translator')->getFromJson('common.package_in_active'); ?></option>
														</select>
													</div>
													<span class="text-danger" id="expand_automatically-error"></span>
												</div>
												<div class="form-group col-md-6">
													<label for="Start_fee"><?php echo app('translator')->getFromJson('common.opstartkosten_label'); ?></label>
													<div class="input-group">
														<span class="input-group-addon">
															<i class="fa fa-address-book-o"></i>
														</span>
														<input type="text" name="Start_fee" class="form-control" id="Start_fee" value="<?php echo e(old('Start_fee')); ?>" placeholder="<?php echo app('translator')->getFromJson('common.opstartkosten_plchldr'); ?>">
													</div>
											...
											<div class="row">
												<div class="form-group col-md-6">
													<label for="entree"><?php echo app('translator')->getFromJson('common.toegang_label'); ?></label>
													<div class="input-group">
														<span class="input-group-addon">
															<i class="fa fa-send-o"></i>
														</span>
														<input type="text" name="entree" class="form-control" id="entree" value="<?php echo e(old('entree')); ?>" placeholder="<?php echo app('translator')->getFromJson('common.toegang_plchldr'); ?>">
													</div>
												...
												<div class="form-group col-md-6">
													...
													<div class="input-group">
														...
														<input type="text" name="enquette" class="form-control" id="enquette" value="<?php echo e(old('enquette')); ?>" placeholder="ex: Enquette">
													</div>
											...
											<div class="row">
												<div class="form-group col-md-6">
													...
													<div class="input-group">
														...
														<input type="text" name="max_users" class="form-control" id="max_users" value="<?php echo e(old('max_users')); ?>" placeholder="ex: Max Users">
													</div>
												...
												<div class="form-group col-md-6">
													...
													<div class="input-group">
														...
														<input name="sell_category" class="form-control" id="sell_category" placeholder="ex: sell_category" value="<?php echo e(old('sell_category')); ?>">
													</div>
											...
											<div class="row">
												<div class="form-group col-md-6">
													<label for="payment_days"><?php echo app('translator')->getFromJson('common.payment_date'); ?></label>
									...
									<?php endif; ?>
							        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->denies('check-route', 'admin.packages.add')): ?>
									<b class="text-center">You are unauthorized for this tab.</b>
									<?php endif; ?>
	                            </div>
	                            <div id="update_package_tab_pane" class="tab-pane  tab-edit-pane active">
	                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('check-route', 'admin.packages.edit')): ?>
									<form role="form" id="package_edit_form" method="post" enctype="multipart/form-data">
										...
										<div class="">
											...
											<div class="row">
												...
												<div class="form-group col-md-6">
													<label for="days"><?php echo app('translator')->getFromJson('common.valid_days_label'); ?></label>
													<div class="input-group">
														<span class="input-group-addon">
															<i class="fa fa-pencil"></i>
														</span>
														<input type="text" name="days" class="form-control" id="edit-days" value="" placeholder="<?php echo app('translator')->getFromJson('common.days_plchldr'); ?>">
													</div>
											...
											<div class="row">
												<div class="form-group col-md-6">
													...
													<div class="input-group">
														...
														<input type="text" name="credits" class="form-control" id="edit-credits" value="" placeholder="<?php echo app('translator')->getFromJson('common.enter_price'); ?>enter_price">
													</div>
												...
												<div class="form-group col-md-6">
													...
													<div class="input-group">
														...
														<input type="text" name="pro_rato" class="form-control" id="edit-pro_rato" value="" placeholder="<?php echo app('translator')->getFromJson('common.pro_rato_plchldr'); ?>">
													</div>
											...
											<div class="row">
												...
												<div class="form-group col-md-6">
													...
													<div class="input-group">
														...
														<input type="text" name="Start_fee" class="form-control" id="edit-Start_fee" value="" placeholder="<?php echo app('translator')->getFromJson('common.opstartkosten_plchldr'); ?>">
													</div>
											...
											<div class="row">
												<div class="form-group col-md-6">
													...
													<div class="input-group">
														...
														<input type="text" name="entree" class="form-control" id="edit-entree" value="" placeholder="<?php echo app('translator')->getFromJson('common.toegang_plchldr'); ?>">
													</div>
										...
										<div class="modal-footer">
											<button type="button" class="btn btn-default btn-flat pull-left" data-dismiss="modal"><?php echo app('translator')->getFromJson('common.close'); ?></button>
											<button type="button" class="btn btn-info btn-flat update-button-package"><?php echo app('translator')->getFromJson('common.update'); ?></button>
										</div>
									</form>
									<?php endif; ?>
							        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->denies('check-route', 'admin.packages.edit')): ?>
									<b class="text-center">You are unauthorized for this tab.</b>
									<?php endif; ?>
	...
	<?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('check-route', 'admin.packages.delete')): ?>
			...
			<div class="modal-content">
				<div class="modal-header">
					<div class="btn-group pull-right no-print">
						...
						<div class="btn-group">
							<button class="tip btn btn-default btn-flat btn-sm" data-toggle="tooltip" data-original-title="<?php echo app('translator')->getFromJson('common.close'); ?>" data-dismiss="modal" aria-label="<?php echo app('translator')->getFromJson('common.close'); ?>">
				...
				<div class="modal-footer no-print">
					<button type="button" class="btn btn-default btn-flat" data-dismiss="modal" aria-label="<?php echo app('translator')->getFromJson('common.close'); ?>"><?php echo app('translator')->getFromJson('common.close'); ?></button>
				</div>
			</div>
		</div>
	</div>
    ...
    <div class="modal fade bulk-delete-modal" id="delete-service-modal-bulk" role="dialog">
        <div class="modal-dialog">
          <div class="modal-content">
             <form method="GET" action="<?php echo e(url('admin/bulk-delete/services')); ?>" id="delete-service-form-bulk">
            <div class="modal-header">
    ...
    <div class="modal fade bulk-delete-modal" id="delete-package-modal-bulk" role="dialog">
        <div class="modal-dialog">
          <div class="modal-content">
             <form method="GET" action="<?php echo e(url('admin/bulk-delete/packages')); ?>" id="delete-package-form-bulk">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body" style="text-align: center;">
...
<?php $__env->startSection('site_scripts'); ?> 
	...
	<script src="<?php echo e(asset('admin_files/vendor/datatables/media/js/jquery.dataTables.min.js')); ?>"></script>
		...
		<script type="text/javascript" src="<?php echo e(asset('public/admin/datatable/js/buttons.flash.min.js')); ?>"></script>
        <script type="text/javascript" src="<?php echo e(asset('public/admin/datatable/js/buttons.colVis.min.js')); ?>"></script>
<script>
		...
		function remove(package_id){
			var url = "<?php echo e(route('admin.packages.destroy', 'package_id')); ?>";
		...
		function remove_service(service_id){
            var url = "<?php echo e(route('admin.services.destroy', 'service_id')); ?>";
		...
		function view(id){
			var url = "<?php echo e(route('admin.packages.show', 'id')); ?>";
		...
		function view_service(id){
            var url = "<?php echo e(route('admin.services.show', 'id')); ?>";
            url = url.replace("id", id);
            $.ajax({
                url: url,
                method: "GET",
		...
		$(".update-button-package").click(function(){
			...
			var url = "<?php echo e(route('admin.packages.update', 'package_id')); ?>";
			url = url.replace("package_id", package_id);
		...
		$(".update-button-service").click(function(){
            ...
            var url = "<?php echo e(route('admin.services.update', 'service_id')); ?>";
            url = url.replace("service_id", service_id);
		...
		function edit(package_id) {
			var url = "<?php echo e(route('admin.packages.show', 'package_id')); ?>";
			url = url.replace("package_id", package_id);
			$.ajax({
				url: url,
				method: "GET",
		...
		function edit_service(service_id){
            var url = "<?php echo e(route('admin.services.show', 'service_id')); ?>";
            url = url.replace("service_id", service_id);
                $.ajax({
                    url: url,
                    method: "GET",
...
//     select_html+= '</select><span class="hvr-grow-shadow"><i class="fa fa-user"></i> Add User</span></div>';
	...
	var datatableInit_package = function() {
		...
		var table = $table.dataTable({
		    bDestroy: true,
			ajax: "<?php echo e(route('admin.getPackagesRoute')); ?>",
			dom: 'Bfrtip',
			buttons: [
            {
	...
	var datatableInit_service = function() {
		...
		var table = $table.dataTable({
		    bDestroy: true,
			ajax: "<?php echo e(route('admin.getServicesRoute')); ?>",
			dom: 'Bfrtip',
			buttons: [
            {
                text:     '<span class="btn hvr-grow-shadow checkbox-delete-btn"><i class="fa fa-trash"></i></span>',
	...
	var datatableInit_finance = function(){
		var $table = $('#datatable-tabletools-financieel');
			var table = $table.dataTable({
				bDestroy: true,
				ajax: "<?php echo e(route('admin.getInvoiceRoute')); ?>",
				dom: 'Bfrtip',
				buttons: [
				{
					text:     '<span class="btn hvr-grow-shadow checkbox-delete-btn"><i class="fa fa-trash"></i></span>',
